...
int main()
{
	...
	while (quit == 'y')
	{
		...
		{
		case K4_MODE:
			p.open("arduino_osu_code/arduino_code_4K.cpp");
			break;
		case K5_MODE:
			p.open("arduino_osu_code/arduino_code_5K.cpp");
			break;
		case K6_MODE:
			p.open("arduino_osu_code/arduino_code_6K.cpp");
			break;
		case K7_MODE:
			p.open("arduino_osu_code/arduino_code_7K.cpp");
			break;
		default:
			break;
		}

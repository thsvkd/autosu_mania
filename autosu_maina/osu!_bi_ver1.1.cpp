...
int main()
{
	...
	while (quit == 'y')
	{
		...
		{
		case K4_MODE:
			p.open("arduino_osu_code/arduino_code_4K.txt");
			break;
		case K5_MODE:
			p.open("arduino_osu_code/arduino_code_5K.txt");
			break;
		case K6_MODE:
			p.open("arduino_osu_code/arduino_code_6K.txt");
			break;
		case K7_MODE:
			p.open("arduino_osu_code/arduino_code_7K.txt");
			break;
		default:
			break;
		}
